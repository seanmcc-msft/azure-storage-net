...
namespace Microsoft.Azure.Storage.Blob
{
    ...
    public partial class CloudBlockBlob : CloudBlob, ICloudBlob
    {
        ...
        /// <param name="sourceAccessCondition">An <see cref="AccessCondition"/> object that represents the conditions on the source that must 
        /// be met in order for the request to proceed. If <c>null</c>, no condition is used.</param>
        /// <param name="destAccessCondition">An <see cref="AccessCondition"/> object that represents the conditions on the destination that must 
        /// be met in order for the request to proceed. If <c>null</c>, no condition is used.</param>
        /// <param name="options">A <see cref="BlobRequestOptions"/> object that specifies additional options for the request.</param>
        /// <param name="operationContext">An <see cref="OperationContext"/> object that represents the context for the current operation.</param>
        ...
        /// <param name="operationContext">An <see cref="OperationContext"/> object that represents the context for the current operation.</param>
        /// <param name="upn">If "true", the user identity values returned in the owner, group, and acl fields will be transformed from Azure Active Directory Object 
        /// IDs to User Principal Names.</param>
        [DoesServiceRequest]
        ...
        /// </summary>
        /// <param name="destUri">A <see cref="Uri"/> specifying location to move CloudBlockBlob to.</param>
        /// <param name="sourceAccessCondition">An <see cref="AccessCondition"/> object that represents the conditions on the source that must be met
        ...
        /// If <c>null</c>, no condition is used.</param>
        /// <param name="operationContext">An <see cref="OperationContext"/> object that represents the context for the current operation.</param>
        /// <param name="upn">If "true", the user identity values returned in the owner, group, and acl fields will be transformed from Azure Active Directory Object IDs 
        /// to User Principal Names.</param>
        /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for a task to complete.</param> 
        [DoesServiceRequest]
